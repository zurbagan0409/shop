				...
				<div class="main-finder col-md-12">
					<div class="text--blue text--center">
						...
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/16.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Розетки и выключатели</h4>
								</div>
							</a>
						...
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/17.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Кабель и монтаж</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/18.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Электрические щиты</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/19.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Климатические системы</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/20.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Звонки и домофоны</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/21.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Системы контроля и управления</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
				...
				<div class="main-finder col-md-12">
					<div class="text--blue text--center">
						...
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/22.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Антенны</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/23.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Осветительные приборы</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/24.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Электрические акссесуары</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/25.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Обработка воздуха</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/26.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Удлинители</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/27.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Автоматика для ворот</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
				...
				<div class="main-finder col-md-12">
					<div class="text--blue text--center">
						...
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/28.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Элементы питания</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
						<div class="col-md-2">
							<a href="category.php">
								<div class="menu-item__image-position">
									<img src="img/catalogue/29.png" alt="Документы" class="menu-item__image menu-item__image--style">
								<h4 class="text--center">Трансформаторы и стабилизаторы</h4>
								</div>
							</a>
							<a href="category.php"><button class='btn-cat-page menu-item__cat'><h4>Перейти</h4></button></a>
						</div>
